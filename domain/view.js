 ...
 * */
    ...
    var OrderLine = require('./order.js').OrderLine;

var renderListPerson = exports.renderListPerson = function (listPerson, DOMelement) {
        ...
        listPersonView += '</lu>';
        if (!DOMelement) { return listPersonView; }
        DOMelement.html(listPersonView);
    }

var renderPerson = exports.renderPerson = function (aPerson, DOMelement) {
        ...
        if (!DOMelement) { return personView; }
